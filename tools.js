/**
 * Общая бизнес-логика инструментов crypto-market-mcp.
 * Используется и stdio-версией (src/index.js), и HTTP-версией (src/http.js).
 */
...
export async function callTool(name, args = {}) {
  switch (name) {
    ...
    case "get_top_coins":
      return await getTopCoins(args);
    case "get_coin_details":
      return await getCoinDetails(args);
    case "search_coin":
      return await searchCoin(args);
    case "get_trending_coins":
      return await getTrendingCoins();
    case "get_fear_greed_index":
      return await getFearGreedIndex(args);
